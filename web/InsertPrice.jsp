                                ...
                                <table>
                                    <thead>
                                        ...
                                        <tr>
                                            <td>City</td>
                                            <td>
                                                <html:select property="distictId" styleId="distictId" >
                                        ...
                                        <%--<tr>
                                            ...
                                            <td>    <html:select property="vegetableId" >
                                                    <html:option value="-1">---Select Vegetable---</html:option>
                                                    <c:forEach  items="${Vege.rowsByIndex}" var="Vege">
                                                        <html:option value="${Vege[0]}">${Vege[1]}</html:option>
                                                    </c:forEach>
