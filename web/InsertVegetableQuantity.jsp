                ...
                <div id="bg2">
                    <div id="bg3">
                        ...
                        <div id="content">
                            ...
                            <sql:query var="qr" dataSource="${dataSource}" sql="select UserDetails.Name,VegetableDetails.VegetableName,QuantityRequest.Quantity,QuantityRequest.UserId,QuantityRequest.Status,QuantityRequest.VegetableId from QuantityRequest INNER JOIN VegetableDetails ON VegetableDetails.VegetableId=QuantityRequest.VegetableId INNER JOIN UserDetails ON UserDetails.UserId= QuantityRequest.UserId where Status='Pending'"/>
                            <table>
                            ...
                            <html:form action="InsertVegetableQuantityAction" method="post" onsubmit="return validateInsertVegetableQuantityActionForm(this);">
                                <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <sql:query var="u" dataSource="${dataSource}" sql="select UserId,name from UserDetails where RoleId !=5 and RoleId !=6 and RoleId !=4;"/>
                                        <tr>
                                            <td>UserId</td>
