        ...
        <div id="header" class="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="veera.jsp" target="_blank">Contact</a></li>
                    ...
                    <div id="bg3">
                        <div id="content">
                            <h3> ${requestScope.msg1} </h3> <br>
                                  <h2>REGISTER</h2>
                                <html:form action="UserDetailsAction" method="post"  onsubmit="return validateUserDetailsActionForm(this);">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><html:select property="roleId">
                                                ...
                                                <html:option value="2">Retailer</html:option>
