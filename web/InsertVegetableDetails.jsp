...
<html:html>
    ...
    <body>
        ...
        <div id="page">
            ...
            <html:javascript formName="InsertVegetableDetailsActionForm"/>
            <html:form action="InsertVegetableDetailsAction" method="post" onsubmit="return validateInsertVegetableDetailsActionForm(this);">
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>VegetableName</td>
                            <td><html:text property="vegetableName" value=""/></td>
                        </tr>
                        <tr>
