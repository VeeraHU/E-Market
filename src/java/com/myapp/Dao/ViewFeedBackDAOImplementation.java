    ...
    public List feedBack(ViewFeedBackBean vfb) {
        ...
        List ls = new ArrayList();
         try{
           ...
           PreparedStatement pst = connection.prepareStatement("Select UserDetails.Name,FeedBack.Feedback,FeedBackType.TypeName from FeedBack INNER JOIN UserDetails ON UserDetails.UserId = FeedBack.UserId INNER JOIN FeedBackType ON FeedBackType.TypeId= FeedBack.TypeId where FeedBack.TypeId=?");
